...
public class Graph_Test_STUDENT {
	...
	public void testGetEdge() {
		assertEquals(new Road(town[2], town[11],6, "Road_5"), graph.getEdge(town[2], town[11]));
		assertEquals(new Road(town[3], town[7],1, "Road_6"), graph.getEdge(town[3], town[7]));
	}
	...
	public void testContainsVertex() {
		...
		assertEquals(false, graph.containsVertex(new Town("Town_9")));
	}
	...
	public void testEdgeSet() {
		...
		assertEquals("Road_9", roadArrayList.get(1));
		assertEquals("Road_10", roadArrayList.get(2));
		assertEquals("Road_12", roadArrayList.get(3));
		assertEquals("Road_4", roadArrayList.get(4));
		assertEquals("Road_6", roadArrayList.get(10));
	}
	...
	public void testRemoveEdge() {
		assertEquals(true, graph.containsEdge(town[2], town[11]));
		graph.removeEdge(town[2], town[11], 6, "Road_11");
	 ...
	 @Test
	  public void testTown_1ToTown_11() {
		  ...
		  if(beginIndex != null && endIndex != null)
		  {
			  ...
			  assertEquals("Town_2 via Road_12 to Town_11 7 mi",path.get(1).trim());
		  }
		  else
	  ...
	  public void testTown1ToTown_10() {
		  ...
		  if(beginIndex != null && endIndex != null)
		  {
			  ...
			  assertEquals("Town_8 via Road_9 to Town_10 3 mi",path.get(2).trim());
		  }
		  else
			  fail("Town names are not valid");
	  ...
	  public void testTown_4ToTown_11() {
		  ...
		  if(beginIndex != null && endIndex != null)
		  {
			  ...
			  assertNotNull(path);
			  assertTrue(path.size() > 0);
			  assertEquals("Town_3 via Road_8 to Town_8 4 mi",path.get(0).trim());
			  assertEquals("Town_6 via Road_10 to Town_10 3 mi",path.get(1).trim());
			  assertEquals("Town_8 via Road_12 to Town_11 4 mi",path.get(2).trim());
		  }
		  else
			  fail("Town names are not valid");
